...
class TwoPersonsTable extends React.PureComponent {


    render() {
        return(
            <div style={{backgroundColor:"#FFFFFF"}}>
                <p className="exportButton">
                    <Button size="small" type="primary">导出记录</Button>
                </p>
                <Row>
                    <Table
...
}), dispatch => bindActionCreators(ActionCreators, dispatch))(TwoPersonsTable)
